  ...
  return (
    <div className="bulk-seach-order-modal">
      ...
      <div className="bulkSearch-main-container">
        <Input.TextArea
          placeholder="Enter multiple order IDs separated by a comma or a new line"
          value={bulkSearch}
          onChange={(e) => {
        ...
        <div className="info-box-container">
          <div>You can bulk search NDR via</div>
          <div>
            1. <span className="id">vFulfill Order ID </span>or,
          </div>
          <div>
            2. <span className="id">Store Order ID </span>or,
          </div>
          <div>
            3. <span className="id">AWB </span>or,
          </div>
          <div>
            4. <span className="id">VFSKU ID </span>
          </div>

...
import { FifthScreenQuestion } from "../question";
...
const ThirdScreen = (props) => {
  ...
  return (
    <div className="onboarding-screen5">
      <div className="question-line">
        <h1>What kind of products you would like to sell? </h1>
        <h2>(3/3)</h2>
      </div>

      <div className="option-wrapper">
        {FifthScreenQuestion.map((question, index) => (
          <motion.div
            key={question.value}
